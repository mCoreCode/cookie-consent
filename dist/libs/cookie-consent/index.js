...
import { useState, useCallback, useEffect, Fragment, forwardRef, StrictMode } from 'react';
...
const useCookieStorage = props => {
  ...
  const [cookies, setCookie] = useCookies(['GCCookieConsent']);
  ...
  const [allowAllStorage, setAllowAllStorage] = useState({});
  const {
    t
  } = useTranslation();
  const getWantedConsent = useCallback(() => {
    const tmpCookieList = [];
      ...
      children: jsxs("div", Object.assign({
        ...
        children: [jsx("span", Object.assign({
          ...
          children: jsxs("p", Object.assign({
            ...
            children: [t('infoPanel.text'), ' ', link && jsx("a", Object.assign({
              href: link,
              target: "_blank",
              rel: "noreferrer",
...
function Modal(props) {
  ...
  return jsx(Transition.Root, Object.assign({
    show: show,
    as: Fragment
  }, {
      ...
      children: [jsx(Transition.Child, Object.assign({
        ...
        children: jsx("div", Object.assign({
          ...
          children: jsx(Transition.Child, Object.assign({
            ...
            children: jsx(Dialog.Panel, Object.assign({
              as: Fragment
            }, {
              children: children
            }))
...
function Switch(props) {
  ...
  return jsxs(Switch$1.Group, Object.assign({
    as: "div",
    ...
    children: [jsxs("div", Object.assign({
      ...
      children: [jsx(Switch$1, Object.assign({
        checked: checked,
        onChange: onChange,
      ...
      })), jsx(Switch$1.Label, Object.assign({
        as: "span",
    ...
    })), jsx(Switch$1.Description, Object.assign({
      as: "span",
...
const SettingsModal = /*#__PURE__*/forwardRef((props, ref) => {
  const {
    link,
    usedCookiesType,
    onClose,
      ...
      children: [jsxs("div", Object.assign({
        ...
        children: [jsxs("div", Object.assign({
          ...
          children: [jsx("span", Object.assign({
            ...
            children: [t('settingsPanel.text'), ' ', link && jsx("a", Object.assign({
              href: link,
              target: "_blank",
              rel: "noreferrer",
        ...
        })), cookiesList.map(cookie => jsx(Switch, {
...
const useCookieConsentSetup = props => {
  ...
  const removeCookieHandler = useCallback(value => {
    return removeCookie(value, {
      path: '/',
      domain: getCookieDomain()
    });
  }, [removeCookie]);
  const removeCookies = useCallback(list => {
    list.forEach(value => {
      if (value.includes('*')) {
  ...
  const checkDeniedCookies = useCallback(e => {
  ...
  const setLanguageHandler = useCallback(localization => {
...
const CookieConsent = props => {
  ...
  const showConsentModalHandler = useCallback(() => {
  ...
  return jsx("div", Object.assign({
    ...
    children: showConsentModal && jsx(ConsentWrapper, {
      usedCookiesType: usedCookiesType,
      link: link
    })
  }));
...
const GCCookieConsentI18n = i18n.createInstance();
GCCookieConsentI18n.init({
  ...
  debug: process__default.env['NODE_ENV'] === 'development',
  react: {
    useSuspense: false
  }
});
...
const init = (config, selector) => {
  return ReactDOM.render(jsx(StrictMode, {
    children: jsx(GCCookieConsent, Object.assign({}, config))
  }), selector);
};
const GCCookieConsent = props => {
  return jsx(CookiesProvider, {
    children: jsx(I18nextProvider, Object.assign({
      i18n: GCCookieConsentI18n
    }, {
      children: jsx(CookieConsent, Object.assign({}, props))
    }))
  });
};

export { GCCookieConsent, gtm, init };
